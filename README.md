...
- updateDescriptionForGridField, extend the autogenerated description of a rule
- updateEvaluateRoadblockData, populate the roadblock record with custom fields / data
- updateEvaluateInfringementData, populate the roadblock exceptions with custom fields / data
...
- updatePrepareRequestLog, used to extend the test suite
- updatePrepareRequestLogs, used to extend the test suite
- updatePrepareLoginAttempts, used to extend the test suite
- updatePrepareCurrentAssessment, used to extend the test suite
- updateNotification - This allow additional content in the various notification emails, can target email
    by subject etc
...
- keep_log_period_seconds, default 1 week
- keep_log_repeat_interval, default 1 day
